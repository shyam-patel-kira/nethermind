...
public partial class EngineModuleTests
{
    ...
    public async Task<int> NewPayloadV3_should_verify_blob_versioned_hashes_against_transactions_ones
        (byte[] hashesFirstBytes, byte[][] transactionsAndFirstBytesOfTheirHashes)
    {
        ...
        return (await rpcModule.engine_newPayloadV3(executionPayload, blobVersionedHashes)).ErrorCode;
    }
